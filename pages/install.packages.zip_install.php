...
if (isset($repos) && is_array($repos)) {
    $githubContent .= '<div id="zip_install_repos" class="panel-group">';
    foreach ($repos as $repo) {
        $githubContent .= '
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><a href="' . $repo['url'] . '" target="_blank">' . rex_escape($repo['name']) . '</a></h4>
            </div>
            <div class="panel-body">
                <p>' . rex_escape($repo['description']) . '</p>
